...
/**
 * BookSearch represents the model behind the search form of `app\modules\admin\models\Books`.
 */
class BookSearch extends Books
{
    ...
    {
        return [
            [['id', 'authorsId', 'genresId'], 'integer'],
            [['booksname', 'description', 'release_date'], 'safe'],
        ];
    }
